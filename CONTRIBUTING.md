...
`AGENTS.md` and `CLAUDE.md` at the repo root configure agents working on the [`maxlopez-xb0/ai-agent-skills-pack-2026`](https://github.com/maxlopez-xb0/ai-agent-skills-pack-2026) repository itself. When writing setup guides or docs, do not instruct users to copy these files into their own projects or into a global agent configuration; the reusable assets are the skills in `skills/`.
...
[Skill gap](https://github.com/maxlopez-xb0/ai-agent-skills-pack-2026/issues/new?template=skill-gap.yml)
